...
module.exports = {
    ...
    SESSION: process.env._CHINTU_SESSION === undefined ? '' : process.env._CYBER_SESSION,
    ...
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://i.ibb.co/JjmP8K2/LOGO.jpg' : process.env.ALIVE_LOGO,
    ...
    CUS_PANEL: process.env.CUS_PANEL === undefined ? 'chintu' : process.env.CUS_PANEL,
    ...
    RULES_LOGO: process.env.RULES_LOGO === undefined ? 'https://i.ibb.co/JjmP8K2/LOGO.jpg' : process.env.RULES_LOGO,
    BRANCH: 'master',
    HEROKU: {
    ...
    SUPPORT1: "120363021831502632@g.us",
